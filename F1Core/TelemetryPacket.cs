...
namespace F1Speed.Core
{
    ...
    {
        public static readonly String NormalizedDistance = "NormalizedDistance";
        public static readonly String SpeedKM = "SpeedKM";
        ...
        public static IEnumerable<String> GetFields()
        {
            ...
            //PropertyInfo[] infos2 = typeof(TelemetryPacket).GetProperties();
            //var propsNames = infos2.Select<PropertyInfo,String>((a) => a.Name);
            //return infos.Select<FieldInfo, String>((a) => a.Name).Union(propsNames);
        ...
        {
            if (fieldName == NormalizedDistance)
                return DistanceMapped;

            if (fieldName == SpeedKM)
