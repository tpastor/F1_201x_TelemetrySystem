...
namespace F1Speed
{
    public partial class Form1 : Form
    {
        ...
        private void UpdateDisplay(Object myObject, EventArgs myEventArgs)
        {
            ...
            label12.Text = manager.LastLapDiffTime.ToString();
            label11.Text = manager.CurrentLapSpeed;
            label15.Text = manager.CurrentLapTopSpeed;
        ...
        {
            RTGraph rt = new RTGraph(manager, true, false, TelemetryPacket.NormalizedDistance, TelemetryPacket.SpeedKM);
            rt.Show();
        }

        private void genericToolStripMenuItem_Click(object sender, EventArgs e)
        {
            GraphOptions go = new GraphOptions(manager);
            go.Show();
        }

        private void allLapsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            AllLaps AllLaps = new AllLaps(manager);
            AllLaps.Show();
        }

        private void timeDeltaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DeltaGraphcs DeltaGraphcs = new DeltaGraphcs(manager, DeltaType.TimeDelta);
            DeltaGraphcs.Show();
        }

        private void speedDeltaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DeltaGraphcs DeltaGraphcs = new DeltaGraphcs(manager, DeltaType.SpeedDelta);
            DeltaGraphcs.Show();
